;;; doom-yokohama-night-theme.el --- inspired by VSCode's yokohama Night theme -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;; Added: December 15, 2021 (#650)
;; Author: FosterHangdaan <https://github.com/FosterHangdaan>
;; Maintainer:
;; Source: https://github.com/enkia/yokohama-night-vscode-theme
;;
;;; Commentary:
;;; Code:
...
;;
;;; Variables
(defgroup doom-yokohama-night-theme nil
  "Options for doom-themes."
  :group 'doom-themes)

(defcustom doom-yokohama-night-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-yokohama-night-theme
  :type 'boolean)

(defcustom doom-yokohama-night-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-yokohama-night-theme
  :type 'boolean)

(defcustom doom-yokohama-night-comment-bg doom-yokohama-night-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their legibility."
  :group 'doom-yokohama-night-theme
  :type 'boolean)

(defcustom doom-yokohama-night-padded-modeline nil
...
;;
;; Theme definition
(def-doom-theme doom-yokohama-night
                "A clean, dark theme that celebrates the lights of downtown yokohama at night."
                ...
                ((bg         '("#1a1b26" nil       nil            ))
                 ...
                 ;; --- Base Faces ------------------------
                 (terminal-black '("#24283b" "#24283b" "black"))
                 ...
                 (selection      base0)
                 (builtin        red)
                 (comments       (if doom-yokohama-night-brighter-comments base5 base1))
                 (doc-comments   (doom-lighten (if doom-yokohama-night-brighter-comments base5 base1) 0.25))
                 (constants      orange)
                 (functions      blue)
                 (keywords       magenta)
                 (methods        blue)
                 ...
                 (-modeline-bright doom-yokohama-night-brighter-modeline)
                 (-modeline-pad
                  (when doom-yokohama-night-padded-modeline
                    (if (integerp doom-yokohama-night-padded-modeline) doom-yokohama-night-padded-modeline 4)))
                 ...
                 (modeline-bg
                  (if -modeline-bright
                      base3
                    `(,(doom-darken (car base1) 0.15) ,@(cdr base0))))
                 (modeline-bg-l
                  (if -modeline-bright
                      base3
                    `(,(doom-darken (car base1) 0.1) ,@(cdr base0))))
                 (modeline-bg-inactive   (doom-darken base1 0.1))
                ...
                (
                 ...
                 (font-lock-comment-face
                  :foreground comments
                  :background (if doom-yokohama-night-comment-bg (doom-lighten bg 0.05)))
                 (font-lock-doc-face
...
;;; doom-yokohama-night-theme.el ends here
