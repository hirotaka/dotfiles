...
(setq doom-font (font-spec :family "PlemolJP35 Console NF" :size 13 :weight 'medium)
      doom-variable-pitch-font (font-spec :family "PlemolJP Console NF" :size 13)
      doom-symbol-font (font-spec :family "PlemolJP Console NF" :size 13))
